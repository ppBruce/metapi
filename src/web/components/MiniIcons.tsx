...
export function BoltIcon({ size = 12 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function GearIcon({ size = 12 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/** Outbound proxy indicator — used in the site list name cell. */
...
/** Custom headers indicator — used in the site list name cell. */
export function SlidersIcon({ size = 12 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function KeyIcon({ size = 12 }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M7 14h.01M11 14h.01M15 14h.01M7 17h10" />
    </svg>
  );
}
